...
Route::put('/semua/update/{id}', [BagController::class, 'update' ])->name('bag.update');
Route::post('/semua/delete/{id}', [BagController::class, 'delete' ])->name('bag.delete');

Route::get('/buku', function(){
    $penulis = Penulis::findOrFail(1);  
    $buku = $penulis->buku;
